...
def get_matches_both_team(obj):
    ...
    # he añadido numero total de partidos jugados local como local, local como visitante, etc
    # hay que calcular de nuevo las probabilidades teniendo en cuenta el numero total de partidos en cada caso
    num_total_match_win_home = num_match_win_home_home + num_match_win_home_visit
    num_total_match_lose_visit = num_match_lose_visit_home + num_match_lose_visit_visit
    ...
    print(num_total_match_win_home)
    print(num_total_match_lose_visit)

    print(num_total_match_win_visit)
    print(num_total_match_lose_home)

    print(num_total_match_empate_home)
    print(num_total_match_empate_visit)
    ...
    return total_matches,num_match_over_05_ht,num_match_over_15_ht,num_match_over_05_ft,num_match_over_15_ft,num_match_over_25_ft,num_match_over_35_ft,num_match_over_05_mitad2,num_match_aem_ft,num_match_aem_ht,num_match_aem_ht2,num_total_match_win_home,num_total_match_lose_visit,num_total_match_win_visit,num_total_match_lose_home,num_total_match_empate_home,num_total_match_empate_visit
...
class MatchDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        total_matches, num_match_over_05_ht, num_match_over_15_ht, num_match_over_05_ft, num_match_over_15_ft, num_match_over_25_ft, num_match_over_35_ft, num_match_over_05_mitad2, num_match_aem_ft, num_match_aem_ht, num_match_aem_ht2,num_total_match_win_home,num_total_match_lose_visit,num_total_match_win_visit,num_total_match_lose_home,num_total_match_empate_home,num_total_match_empate_visit = get_matches_both_team(self.get_object())
        ...
        prob_win_home = (np.round(100 * num_total_match_win_home / total_matches, 2) + np.round(100 * num_total_match_lose_visit / total_matches, 2))/2
        prob_win_visit = (np.round(100 * num_total_match_win_visit / total_matches, 2) + np.round(100 * num_total_match_lose_home / total_matches, 2))/2
        prob_empate = (np.round(100 * num_total_match_empate_home / total_matches, 2) + np.round(100 * num_total_match_empate_visit / total_matches, 2))/2

        context['prob_win_home'] = prob_win_home
        context['cuota_win_home'] = np.round((1/prob_win_home)*100,2)
        context['prob_win_visit'] = prob_win_home
        context['cuota_win_visit'] = np.round((1/prob_win_visit)*100,2)
        context['prob_empate'] = prob_win_home
